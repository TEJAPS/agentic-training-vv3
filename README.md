...
### **Day 3: Attention & Hands-on Transformer**
- **Topics**:
...
### **Day 4: LLM vs GenAI vs Agentic AI, and N8N framework**
- **Topics**:
...
### **Day 5: Agents & Multi-Agent Systems using OPENAI SDK**
- **Topics**:
  - What are AI Agents?
...
### **Day 6: Models, Use Cases, Agile And Agentic AI Open SDK Frameowrk**
- **Topics**:
...
### **Day 7: Langchain and Langsmith Agentic Frameworks**
- **Topics**:
...
- **AI evaluation**: agent is good or bad?
  - Prompt evaluation
  ...
  - Regression testing
    - Ex: compare GPT vs Claud vs Gemini on same task
    - Evaluate hallucinations
  - Tools:
    - Langmith, DeepEval, OpenAI Evals, Ragas, Promptfoo
...
- **AI security and guardrails**:
  ...
  - Practical:
    - attack chatbot, protect, moderation layer, approval system
  - Tools:
    - Guardrais AI, NeMo GuardRails, OpenAI moderation, Pydantic validation
...
- **Cost optimization**
  ...
  - token optimization
  - Practical:
    - cheal model for easy tasks
    - expensive model for reasoning tasks
- **Memory:**
  - Conversation memory
  - Episodic memory
  - Semantic memory
